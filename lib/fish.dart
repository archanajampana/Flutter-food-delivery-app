...
class BiryaniScreen1 extends StatefulWidget {
  @override
  _BiryaniScreenState createState() => _BiryaniScreenState();
}

class _BiryaniScreenState extends State<BiryaniScreen1> {
  String _selectedCategory = 'Fish Fry';
    ...
    'Fish Fry': [
      {
        'name': 'Fish fry',
        'price': '₹350',
        'image': 'https://th.bing.com/th?id=OIP.q5bKa-KpYCfn0JjX--03KwHaFj&w=288&h=216&c=8&rs=1&qlt=90&o=6&dpr=1.7&pid=3.1&rm=2',
      ...
      },
      {
        'name': 'Special fish ',
        'price': '₹450',
        'image': 'https://th.bing.com/th/id/OIP.DXQM49M6mFPh3MsRCAvBnQHaLH?w=186&h=279&c=7&r=0&o=5&dpr=1.7&pid=1.7',
    ...
    'Fish curry': [
      {
        ...
        'price': '₹400',
        'image': 'https://th.bing.com/th/id/OIP.BUt9E2AygirjScbzKq7ThAHaFj?w=186&h=140&c=7&r=0&o=5&dpr=1.7&pid=1.7',
      ...
      },
      {
        'name': 'Spicy fish',
        'price': '₹420',
        'image': 'https://th.bing.com/th/id/OIP.AewBD7tPIzIEwuwqWk4E2QHaE8?w=186&h=124&c=7&r=0&o=5&dpr=1.7&pid=1.7',
