...
class BiryaniScreen7 extends StatefulWidget {
  @override
  _BiryaniScreenState createState() => _BiryaniScreenState();
}

class _BiryaniScreenState extends State<BiryaniScreen7> {
  String _selectedCategory = 'Palak Panner';
    ...
    'Palak Panner': [
      {
        'name': 'Paneer pride',
        'price': '₹350',
        'image': 'https://th.bing.com/th/id/OIP.BDokOe3JpoPLbe1raLM-IgHaEK?w=186&h=104&c=7&r=0&o=5&dpr=1.7&pid=1.7',
    ...
    'Paneer Bhurji': [
      {
        'name': 'Special Paneer ',
        'price': '₹400',
        'image': 'https://th.bing.com/th/id/OIP.Lq_gN9i1ORd_CdPW06xT0gHaJj?w=186&h=239&c=7&r=0&o=5&dpr=1.7&pid=1.7',
