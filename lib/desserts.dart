...
class BiryaniScreen6 extends StatefulWidget {
  @override
  _BiryaniScreenState createState() => _BiryaniScreenState();
}

class _BiryaniScreenState extends State<BiryaniScreen6> {
  String _selectedCategory = 'Custard';
    ...
    'Custard': [
      {
        'name': 'Fruit mix',
        'price': '₹350',
        'image': 'https://th.bing.com/th/id/OIP.QrE6zuBmuOX_K6wm4PiBzgHaLE?w=186&h=278&c=7&r=0&o=5&dpr=1.7&pid=1.7',
      ...
      },
      {
        'name': 'Slicy bowl',
        'price': '₹450',
        'image': 'https://th.bing.com/th/id/OIP.83_WgVOERgfvWNv2SQRJ3gHaHa?w=186&h=186&c=7&r=0&o=5&dpr=1.7&pid=1.7',
    ...
    'Cheese Cake': [
      {
        'name': 'Cheese cake',
        'price': '₹400',
        'image': 'https://th.bing.com/th/id/OIP.gnfyh5eVhAcBTN8CrGXMBAAAAA?w=186&h=186&c=7&r=0&o=5&dpr=1.7&pid=1.7',
