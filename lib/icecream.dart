...
class BiryaniScreen8 extends StatefulWidget {
  @override
  _BiryaniScreenState createState() => _BiryaniScreenState();
}

class _BiryaniScreenState extends State<BiryaniScreen8> {
  String _selectedCategory = 'Dry Fruit';
  ...
  final Map<String, List<Map<String, String>>> _restaurantData = {
    'Dry Fruit': [
      {
        'name': 'Mixed Delight',
        'price': '₹350',
        'image': 'https://th.bing.com/th/id/OIP.PCskyidVP5GG_BgBkPAyfQAAAA?w=176&h=176&c=7&r=0&o=5&dpr=1.7&pid=1.7',
      ...
      {
        'name': 'Dryfruit reward',
        'price': '₹450',
        'image': 'https://th.bing.com/th/id/OIP.EHoJNHRRCyYqPW_xGE2VXQHaEK?w=186&h=104&c=7&r=0&o=5&dpr=1.7&pid=1.7',
    ...
    'Chocolate': [
      {
        'name': 'Choco Overloaded',
        'price': '₹400',
        'image': 'https://th.bing.com/th/id/OIP.VWUHpuA_2yaDbYMe0KZgXwHaGM?w=186&h=155&c=7&r=0&o=5&dpr=1.7&pid=1.7',
